...
<nav class="navbar navbar-expand-lg ">
    ...
    <% if (userType != null && userType.equals("college")) { %>
        <li class="nav-item active"><a class="nav-link" href="appliedStudents"><span class="text-white">Applied Students</span></a></li>
    <% } %>

    <% if (userType == null) { %>
        <li class="nav-item active"><a class="nav-link" href="adminlogin"><span class="text-white">Admin Login</span></a></li>
        <li class="nav-item active"><a class="nav-link" href="collegelogin"><span class="text-white">College Login</span></a></li>
    <% } %>
    
    <% if (userType == null || !userType.equals("admin")) { %>  <!-- This ensures it's not an admin -->
        <li class="nav-item active text-white ml-2" data-toggle="modal" data-target=".aboutusmodal">
            <div class="nav-link">
                <span class="text-white">About us</span>
            </div>
        </li>

        <li class="nav-item active text-white ml-2" data-toggle="modal" data-target=".contactusmodal">
            <div class="nav-link">
...
<div class="modal fade -modal" tabindex="-1" role="dialog"
				...
				<div class="container text-center text-color">
					<p style="font-size: 23px;">
						<span> <img src="resources/images/phonee.png"
							style="width: 27px;" alt="img">+91 9999999999 / +91
							8888888888<br> <img src="resources/images/emaill.png"
							style="width: 29px;" alt="img">university@cts.com
						</span>
					</p>
				</div>
			</div>
